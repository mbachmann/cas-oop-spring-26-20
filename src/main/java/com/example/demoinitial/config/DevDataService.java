...
public class DevDataService implements HasLogger {
    ...
    /**
     * Seeds initial user accounts if they do not already exist in the database.
     * Checks for existence by email address before saving to ensure idempotency.
     *
     * <h3>Seeded users:</h3>
     * <ul>
     *   <li>Felix Muster ({@code felix.muster@example.com})</li>
     * </ul>
     */
    ...
    private User createUserIfNotFound(String name, String eMail, String password) {
